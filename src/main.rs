...
/// This tool renames a BAM tag. A task that should normally not be necessary and is likely not recommended at all. I expect you to know what you are doing here!
#[derive(Parser)]
